...
//		firstHero.setTotalManaCrystals(33);
//		secondHero.setTotalManaCrystals(33);
//		firstHero.setCurrentManaCrystals(55);
//		secondHero.setCurrentManaCrystals(55);
	}
	...
	public void onCastSpell(AOESpell s, ArrayList<Minion> oppField) {
		if(listener != null) {
        	listener.onCastSpell(s,oppField);
        }
	...
	public void onAttackWithMinion(Minion attacker, Minion target) {
		if(listener != null) {
        	listener.onAttackWithMinion(attacker, target);;
        }
